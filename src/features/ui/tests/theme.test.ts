import { getHouseColors } from '../types/theme'
import { HouseName } from '../types/api'
...
describe('Theme Utilities', () => {
  describe('getHouseColors', () => {
    ...
    it('should handle null/undefined gracefully', () => {
      const colorsNull = getHouseColors(null as unknown as HouseName)
      const colorsUndefined = getHouseColors(undefined as unknown as HouseName)
